 ...
 function myFunction()
 {
 var x,text,wrong,notc;
 x = document.getElementById("username1").value;
 notc="Please Enter Username";
 ...
 if(x=='')
 {
   ...
   document.getElementById("demo").innerHTML= notc;
  
 
  if(x.length<6) 
 {
     document.getElementById("uerror").innerHTML="<img src='wr.jpg' height='15px'/>";
     
 }
 else 
 {
     document.getElementById("uerror").innerHTML="<img src='wt.jpg' height='15px'/>";
     
 }
 }
 else if(isNaN(x) || x < 10 || x >33)
 {
 ...
 ?>
       ...
       <form name="form1" method="post" action="adminlogincode.php">  
       Admin Login
	   <input type="text" name="name" id="name" placeholder="Username" required>
	   <input type="password" name="Apass" id="pass1" placeholder="Password" required>
	   <input type="hidden" name="M_id" id="M_id" placeholder="Market_id">   
	   <input type="submit" name="b1" value="Login">
	     </form>

	   
	<div >
	 <marquee behavior="scroll" direction="" loop="-1" scrollamount="12" 
     scrolldelay="100" onmouseover="this.stop();" 
	 onmouseout="this.start();" onmouseout="this.stop()" 
      height="30px" 
     style="height: 30px; color: rgb(20,20,200); background-color: rgb(255,240,200);
	 font-size: x-large; font-style: italic; font-weight: 700;
	 ">
	<?php
    ...
    while($row=mysqli_fetch_array($query))  
       { 
         ...
         echo "<a href=\"newsPage.php?id1=".$row['id']."\" target='_blank'>";
         echo  $row["heading"];
         echo '</a>';
