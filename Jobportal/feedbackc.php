...
$cmd="insert into feedback(name,email,address,message)values('$fname','$femail','$faddress','$fmessage')";
$stor=mysql_query($cmd)or die("query not work");
echo "<h2><font color='blue'>Your feddback send successfully.. Thank You ! </font> </h2>";
?>
