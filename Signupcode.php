...
<body bgcolor="White">
<form name="form1" action="Signupcode.php" method="POST" onSubmit="return check();">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <table style="width:100%; height: 2px;">
      <tr>
        <td class="style3">
            <h1 style="background-color: #660066; height: 47px;">
                <span class="style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span class="style2">&nbsp; <a href="home.php"><span class="style44">Home</span></a><span 
                    class="style44"> </span> </span>
                <span class="style44">&nbsp;&nbsp;&nbsp;                </span> 
                <span class="style2"> <a href="Aboutus.php"><span class="style43">AboutUs</span></a></span><span 
                    class="style44">&nbsp;&nbsp;&nbsp; 
                </span> 
                <span class="style2"> <a href="contacts.php"><span class="style43">Contacts</span></a></span><span 
                    class="style44">&nbsp;&nbsp;&nbsp; 
                </span> 
                <span class="style2"> <a href="SignupPage.php"><span class="style46">Signup Now</span></a></span><span 
                    class="style44">&nbsp;&nbsp;&nbsp;&nbsp; 
                </span> 
                <span class="style2"> <a href="login.php"><span class="style45">Login</span></a></span><span 
                    class="style44">&nbsp;&nbsp;</span>&nbsp;&nbsp; &nbsp;<span 
                    class="style2">&nbsp;&nbsp;&nbsp;</span>
...
$cc=mysql_query("select * from usermaster where username='$lid'");
...
$cmd="insert into usermaster(username,password,email,mono,adharno,gender,address,city,pincode,state,securityquestion,securityanswer,dateofbirth)values('$lid','$pass','$email','$mobn','$adharno','$gen','$address','$city','$pincode','$state','$sq','$answer','$day/$Month/$Year')";
$stor=mysql_query($cmd)or die("query not work");
echo "<h2>Your Account is successfully created login now</h2>";
?>
</center>
	  &nbsp;</p>
